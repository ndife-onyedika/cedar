...
from savings.utils.helpers import check_activity_exec
...
def import_csv():
    ...
    # csv_urls = ["SavingsDebit-2023-2024.csv"]
    ...
    #                     pass
    #                     # member = Member.objects.get(name__iexact=row["member"])
    #                     # SavingsDebit.objects.get_or_create(
    #                     #     member=member,
    #                     #     amount=row["amount"],
    #                     #     reason=row["reason"],
